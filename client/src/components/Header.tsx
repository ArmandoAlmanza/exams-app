            ...
            <header
                className={`${
                    screenScroll >= 50
                        ...
                        : "bg-body"
                } sticky top-0 flex flex-row justify-between p-4 border-b border-b-black content-center items-center md:flex-col md:justify-evenly md:border-b-0 md:border-r md:border-r-black  md:w-64`}
            >
